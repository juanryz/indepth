...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Home - PT Tirta Bhumi Indonesia','description' => 'PT Tirta Bhumi Indonesia adalah perusahaan penyedia solusi terpadu yang berfokus pada transformasi digital, infrastruktur IT, pengadaan barang & jasa, serta pengembangan SDM.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Home - PT Tirta Bhumi Indonesia','description' => 'PT Tirta Bhumi Indonesia adalah perusahaan penyedia solusi terpadu yang berfokus pada transformasi digital, infrastruktur IT, pengadaan barang & jasa, serta pengembangan SDM.']); ?>
    <!-- Hero Section -->
        ...
        <div class="relative container mx-auto px-6 text-center z-20 flex-grow flex flex-col justify-center pt-40">
            ...
            <div
                ...
                <span id="rotating-text" class="text-sm font-semibold text-slate-700 transition-opacity duration-500">
                    <?php echo e(__('messages.hero_rotating_text.0')); ?>
            ...
            <h1
                ...
                <?php echo e(__('messages.hero_title_1')); ?>

                <br />
                <?php echo e(__('messages.hero_title_2')); ?>
            ...
            <div class="flex flex-col md:flex-row gap-6 justify-center animate-fade-in-up animation-delay-300">
                <a href="<?php echo e(route('contacts.index')); ?>"
                    ...
                    <?php echo e(__('messages.footer_cta_btn')); ?>
        ...
        <div class="relative container mx-auto px-6 text-center z-20 pb-12 animate-fade-in-up animation-delay-400">
                ...
                <div class="group relative flex overflow-hidden py-10 px-4 gap-8 flex-row w-full max-w-6xl mx-auto">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="<?php echo e(asset('images/partners/partner-1.png')); ?>" alt="Partner 1" loading="lazy"
                                width="128" height="80" class="max-w-full max-h-full transition-all duration-300">
                        </div>
                        <div
                            class="w-32 h-20 neu-flat rounded-xl flex items-center justify-center p-3 border border-white/50 hover:-translate-y-1 transition-transform duration-300">
                            <img src="<?php echo e(asset('images/partners/partner-2.png')); ?>" alt="Partner 2" loading="lazy"
                                width="128" height="80" class="max-w-full max-h-full transition-all duration-300">
                        </div>
                        <div
                            class="w-32 h-20 neu-flat rounded-xl flex items-center justify-center p-3 border border-white/50 hover:-translate-y-1 transition-transform duration-300">
                            <img src="<?php echo e(asset('images/partners/partner-3.png')); ?>" alt="Partner 3" loading="lazy"
                                width="128" height="80" class="max-w-full max-h-full transition-all duration-300">
                        </div>
                        <div
                            class="w-32 h-20 neu-flat rounded-xl flex items-center justify-center p-3 border border-white/50 hover:-translate-y-1 transition-transform duration-300">
                            <img src="<?php echo e(asset('images/partners/partner-4.png')); ?>" alt="Partner 4" loading="lazy"
                                class="h-14 w-auto object-contain transition-all duration-300">
                        </div>
                        <div
                            class="w-32 h-20 neu-flat rounded-xl flex items-center justify-center p-3 border border-white/50 hover:-translate-y-1 transition-transform duration-300">
                            <img src="<?php echo e(asset('images/partners/partner-5.png')); ?>" alt="Partner 5" loading="lazy"
                                width="128" height="80" class="max-w-full max-h-full transition-all duration-300">
                        </div>
                    </div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    // Rotating Text Logic
                    const texts = <?php echo json_encode(__('messages.hero_rotating_text'), 15, 512) ?>;
    ...
    <section id="upventure" class="py-24 bg-slate-50 relative">
        <div class="container mx-auto px-6">
            ...
            <div class="mb-12 reveal-bottom">
                <h2 class="text-xl font-bold text-slate-500 mb-2"><?php echo e(__('messages.training_title')); ?></h2>
                <h3 class="text-3xl md:text-5xl font-bold text-slate-800 mb-4 leading-tight">
                    <?php echo e(__('messages.class_title')); ?>

                </h3>
                <p class="text-slate-500 text-lg mb-8">
                    <?php echo e(__('messages.class_desc')); ?>

                </p>

                <div class="flex flex-col md:flex-row justify-end items-center gap-6">
                    <a href="<?php echo e(route('trainings.list')); ?>"
                        ...
                        <?php echo e(__('messages.see_all')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trainings->count() > 0): ?>
                <div class="grid md:grid-cols-3 gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $trainings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $training): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if (isset($component)) { $__componentOriginal46118f46299804cc21a0751daeeb7273 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal46118f46299804cc21a0751daeeb7273 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.training-card','data' => ['training' => $training]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('training-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['training' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($training)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal46118f46299804cc21a0751daeeb7273)): ?>
<?php $attributes = $__attributesOriginal46118f46299804cc21a0751daeeb7273; ?>
<?php unset($__attributesOriginal46118f46299804cc21a0751daeeb7273); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal46118f46299804cc21a0751daeeb7273)): ?>
<?php $component = $__componentOriginal46118f46299804cc21a0751daeeb7273; ?>
<?php unset($__componentOriginal46118f46299804cc21a0751daeeb7273); ?>
<?php endif; ?>
            ...
            <?php else: ?>
                <div class="text-center py-24 bg-white rounded-3xl border border-slate-100 shadow-sm">
                    ...
                    <h3 class="text-xl font-bold text-slate-800 mb-2"><?php echo e(__('messages.class_empty_title')); ?></h3>
                    <p class="text-slate-500"><?php echo e(__('messages.class_empty_desc')); ?></p>
                </div>
    ...
    <section class="py-24 bg-white" id="news-blog">
        <div class="container mx-auto px-6">
            <!-- Header -->
            <div class="mb-12 reveal-bottom">
                <h2 class="text-xl font-bold text-slate-500 mb-2"><?php echo e(__('messages.news_blog_title')); ?></h2>
                <h3 class="text-3xl md:text-5xl font-bold text-slate-800 mb-4 leading-tight">
                    <?php echo e(__('messages.news_blog_subtitle')); ?>

                </h3>
                <p class="text-slate-500 text-lg mb-8">
                    <?php echo e(__('messages.news_blog_desc')); ?>
                ...
                <div class="flex flex-col md:flex-row justify-end items-center gap-6">
                    <!-- See All Button -->
                    <a id="see-all-btn" href="<?php echo e(route('blog.index')); ?>"
                        class="neu-flat px-6 py-2 rounded-full text-sm font-bold text-slate-700 hover:text-indigo-600 transition-colors flex items-center">
                        <?php echo e(__('messages.see_all')); ?>
            ...
            <div class="relative min-h-[400px] reveal-bottom delay-200">
                ...
                <div id="content-blog">
                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\Post::with('category')->latest()->take(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('blog.show', $post)); ?>"
                                ...
                                <div class="relative aspect-video overflow-hidden bg-slate-100">
                                    ...
                                    ?>
                                    <img src="<?php echo e($blogImage); ?>" alt="<?php echo e($post->title); ?>" loading="lazy"
                                ...
                                <div class="p-6">
                                    <div class="flex items-center gap-3 mb-4">
                                        ...
                                        <span
                                            class="text-xs text-slate-500"><?php echo e($post->created_at->format('M d, Y')); ?></span>
                                    </div>
                                    <h3
    ...
    <section id="services" class="py-24 relative overflow-hidden bg-[#eef2f6] scroll-mt-24">
        <div class="container mx-auto px-6 relative z-10">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                ?>
                <a href="<?php echo e(route('services.digital')); ?>"
                    ...
                    <div
                        ...
                        <svg class="w-32 h-32" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="<?php echo e($s1_icon); ?>"></path>
                        </svg>
                    </div>
                    ...
                    <div class="px-2 flex-grow flex flex-col z-20">
                        <h3
                            ...
                            <?php echo e(__('messages.service_digital_title')); ?>

                        </h3>
                        <p class="text-slate-500 text-xs leading-relaxed mb-4 flex-grow relative z-20">
                            <?php echo e(__('messages.service_digital_desc')); ?>
                ...
                <a href="<?php echo e(route('services.infrastructure')); ?>"
                    class="group neu-flat overflow-hidden p-4 hover:scale-[1.02] transition-all duration-500 flex flex-col relative">
                    <!-- Decorative background icon -->
                    <div
                        ...
                        <svg class="w-32 h-32" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="<?php echo e($s2_icon); ?>"></path>
                        </svg>
                    </div>
                    ...
                    <div class="px-2 flex-grow flex flex-col z-20">
                        <h3
                            ...
                            <?php echo e(__('messages.service_infra_title')); ?>

                        </h3>

                        <p class="text-slate-500 text-xs leading-relaxed mb-4 flex-grow relative z-20">
                            <?php echo e(__('messages.service_infra_desc')); ?>
                ...
                ?>
                <a href="<?php echo e(route('trainings.index')); ?>"
                    class="group neu-flat overflow-hidden p-4 hover:scale-[1.02] transition-all duration-500 flex flex-col relative">
                    <!-- Decorative background icon -->
                    <div
                        ...
                        <svg class="w-32 h-32" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="<?php echo e($s3_icon); ?>"></path>
                        </svg>
                    </div>
                    ...
                    <div class="px-2 flex-grow flex flex-col z-20">
                        <h3
                            ...
                            <?php echo e(__('messages.service_people_title')); ?>

                        </h3>
                        <p class="text-slate-500 text-xs leading-relaxed mb-4 flex-grow relative z-20">
                            <?php echo e(__('messages.service_people_desc')); ?>
                ...
                ?>
                <a href="<?php echo e(route('services.procurement')); ?>"
                    class="group neu-flat overflow-hidden p-4 hover:scale-[1.02] transition-all duration-500 flex flex-col relative">
                    <!-- Decorative background icon -->
                    <div
                        ...
                        <svg class="w-32 h-32" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            <path d="<?php echo e($s4_icon); ?>"></path>
                        </svg>
                    </div>
                    ...
                    <div class="px-2 flex-grow flex flex-col z-20">
                        <h3
                            ...
                            <?php echo e(__('messages.service_procurement_title')); ?>

                        </h3>
                        <p class="text-slate-500 text-xs leading-relaxed mb-4 flex-grow relative z-20">
                            <?php echo e(__('messages.service_procurement_desc')); ?>
            ...
            <div class="flex flex-col lg:flex-row gap-16 items-center reveal-bottom">
                <div class="lg:w-6/12">
                    <h2 class="text-4xl md:text-5xl font-extrabold text-slate-900 mb-8 leading-tight">
                        <?php echo e(__('messages.why_us_title')); ?>

                    </h2>
                    <p class="text-slate-500 text-lg leading-relaxed mb-8">
                        <?php echo e(__('messages.why_us_main_desc')); ?>
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="text-center max-w-2xl mx-auto mb-16 reveal-bottom">
                ...
                <h3 class="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6 leading-snug">
                    <?php echo e(__('messages.why_us_subtitle')); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group neu-flat p-6 transition-all duration-300 hover:scale-[1.02] flex flex-col reveal-bottom relative overflow-hidden"
                        style="transition-delay: <?php echo e(($loop->index * 50)); ?>ms">

                        <div
                            class="w-12 h-12 rounded-2xl bg-<?php echo e($f['color']); ?>-50 flex items-center justify-center text-<?php echo e($f['color']); ?>-600 mb-6 shadow-sm group-hover:scale-110 transition-transform duration-300 relative z-10">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <h4
                            ...
                            <?php echo e(__('messages.why_us_feat_' . $f['id'] . '_title')); ?>

                        </h4>
                        <p class="text-slate-500 text-xs leading-relaxed flex-grow relative z-20">
                            <?php echo e(__('messages.why_us_feat_' . $f['id'] . '_desc')); ?>
    ...
    <section id="testimonials" class="py-24 bg-white">
        <div class="container mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(is_array($testimonials)): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = collect($testimonials)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white p-8 rounded-[2rem] shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300 flex flex-col reveal-bottom"
                            ...
                            <div class="flex items-center gap-1 text-amber-400 mb-6">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 0; $i < ($testi['rating'] ?? 5); $i++): ?>
                            ...
                            <p class="text-slate-600 mb-8 flex-grow leading-relaxed italic">"<?php echo e($testi['text']); ?>"</p>
                            <div class="flex items-center gap-4 mt-auto">
                                <img src="<?php echo e($testi['avatar']); ?>" alt="<?php echo e($testi['author']); ?>"
                                    class="w-12 h-12 rounded-full object-cover border-2 border-indigo-50">
                                <div>
                                    <h4 class="font-bold text-slate-900 text-sm"><?php echo e($testi['author']); ?></h4>
                                    <span class="text-xs text-slate-500"><?php echo e($testi['role']); ?></span>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\InDepth\indepth\resources\views/welcome.blade.php ENDPATH**/ ?>